...
function PromoCard({ item }) {
  return (
    <a
      ...
      className="flex-shrink-0 w-72 flex items-start gap-3 mx-2 px-4 py-3 rounded-2xl bg-white/5 border border-white/8 hover:bg-white/10 hover:border-indigo-500/30 transition-all group cursor-pointer"
    >
      ...
      <div className="min-w-0 flex-1">
        <p className="text-slate-200 text-xs font-semibold leading-snug line-clamp-2 group-hover:text-amber-200 transition-colors">
          {item.title}
        </p>
