...
-- Alerts: users see/modify only their own
...
-- Alert hits: users see hits for their alerts
...
-- Search events: public insert, service role reads
...
-- No explicit grants needed for service_role.

-- ── 7. EMAIL AUTH CONFIG ──────────────────────────────────
-- In Supabase Dashboard → Authentication → Settings:
-- - Enable "Email" provider
-- - Enable "Magic Link" / OTP
-- - Set Site URL: https://miles-optimizer-next.onrender.com
-- - Set Redirect URL: https://miles-optimizer-next.onrender.com

-- ── DONE ──────────────────────────────────────────────────
-- After running this script, copy from Dashboard → Settings → API:
--   Project URL    → SUPABASE_URL
--   anon key       → SUPABASE_ANON_KEY (or use the publishable key)
